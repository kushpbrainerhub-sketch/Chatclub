"""
List of valid countries (ISO 3166-1 alpha-2 code -> English name).

The frontend has the SAME list in frontend/src/countries.js.
...
# A set is fast for "is this code valid?" checks.
